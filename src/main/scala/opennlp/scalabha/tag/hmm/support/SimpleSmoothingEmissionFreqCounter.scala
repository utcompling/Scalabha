 ...
 */
class SimpleSmoothingEmissionFreqCounter[Tag, Sym](lambda: Double, startEndSymbol: Sym, startEndTag: Tag, tagDict: Map[Sym, Set[Tag]], backoffData: Iterable[Iterable[Sym]], delegate: CondFreqCounter[Tag, Sym])
  extends SimpleSmoothingCondFreqCounter[Tag, Sym](lambda, tagDict, backoffData, delegate) {
